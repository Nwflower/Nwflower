...
**更多 DSH 生态 / More from the DSH ecosystem:**

- [dsh-file-claim](https://github.com/Nwflower/dsh-file-claim) — 多会话并发工作区的文件认领与写入保护：心跳过期接管、异步三路合并区
- [dsh-weneed](https://github.com/Nwflower/dsh-weneed) — 让 DSH 稳定触发 We Need 思维链
- [dsh-bash-wsl](https://github.com/Nwflower/dsh-bash-wsl) — DSH 的 bash / WSL Shell 插件
...
![](https://img.shields.io/badge/-WebStorm-000000?style=flat-square&logo=jetbrains&logoColor=fff)
